...
export const searchCampaignsTool = f.query('sf_search_campaigns')
    ...
    .handle(async (i) => await searchCampaigns(i.query, i.limit as any));
...
export const getCampaignsByStatusTool = f.query('sf_campaigns_by_status')
    ...
    .egress(1024*1024).returns(SFPresenter)
    .handle(async (i) => await getCampaignsByStatus(i.status, i.limit as any));
...
export const createCampaignTool = f.action('sf_create_campaign')
    ...
    .returns(SFPresenter)
    .handle(async (i) => await createCampaign(i as any));
...
export const getCampaignMembersTool = f.query('sf_campaign_members')
    ...
    .egress(1024*1024).returns(SFPresenter)
    .handle(async (i) => await getCampaignMembers(i.campaignId, i.limit as any));
...
export const addCampaignMemberTool = f.action('sf_add_campaign_member')
    ...
    .returns(SFPresenter)
    .handle(async (i) => await addCampaignMember(i.campaignId, i.contactId, i.leadId, i.status as any));
